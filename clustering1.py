...
#pos = clus.fit(data).embedding_
pos = clus.fit(data)
#pos = clus.fit_transform(data)
print(pos.labels_)
'''
for i in range(485):
...
'''
core_samples_mask = np.zeros_like(pos.labels_, dtype=bool)
core_samples_mask[pos.core_sample_indices_] = True
labels = pos.labels_
